...
public class MoKeeExtTelephony extends IExtTelephony.Stub {
    ...
    private static MoKeeExtTelephony sInstance;
    ...
    public static MoKeeExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new MoKeeExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private MoKeeExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
